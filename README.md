...
quote-of-the-day widget underneath), a calendar widget (iCloud plus a
second subscribed ICS feed), and a live BBC News/Sport ticker, with
...
ticker, and DummyJSON (`dummyjson.com/quotes/random`) for quote-of-the-day
(both cached per calendar day).
